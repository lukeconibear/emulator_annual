...
#    try:
    with xr.open_dataset(f'/nobackup/earlacoa/machinelearning/data_annual/predictions/{output}/{filename}') as ds:
...
def main():
    ...
    print('saving ...')
    joblib.dump(outputs_popweighted, f'/nobackup/earlacoa/machinelearning/data_annual/popweighted/popweighted_{region}_{output}_0.25deg.joblib')
