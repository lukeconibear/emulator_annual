...
def main():
    ...
    custom_outputs = glob.glob(f'/nobackup/earlacoa/machinelearning/data_annual/predictions/{output}/ds*{output}.nc')
    custom_outputs_completed = glob.glob(f'/nobackup/earlacoa/machinelearning/data_annual/predictions/{output}/ds*{output}_popgrid_0.25deg.nc')
