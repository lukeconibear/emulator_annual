...
obs_files = glob.glob('/nobackup/earlacoa/machinelearning/data_annual/china_measurements_corrected/*.nc')
...
df_obs.to_csv('/nobackup/earlacoa/machinelearning/data_annual/china_measurements_corrected/df_obs_o3_6mDM8h_ppb_PM2_5_DRY.csv')
